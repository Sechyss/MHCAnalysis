...
% Solve the ODE again using the last entry as the initial condition
    ...
    tspan = time_variable(i):time_variable(i)+180;
...
colors = {'#F00FFF','#00FFFF','#0080FF','#F0FFFF','#F080FF','#FF0000', ...
    '#800000','#FF0080','#800080','#FFFF00','#80FF00','#FFFF80','#80FF80', ...
    '#0000FF','#8000FF','#0080FF','#8080FF','#FF8000','#F0F0FF','#00FFFF', ...
    '#0080FF','#F0FFFF','#F080FF','#FF0000','#800000','#FFFF00','#80FF00', ...
    '#0000FF','#8000FF','#0080FF','#8080FF','#FF8080','#FF00FF','#00FFFF', ...
    '#0080FF','#F0FFFF','#F080FF','#FF0000','#800000','#FFFF00','#80FF00', ...
    '#0000FF','#8000FF','#0080FF','#8080FF','#FF8000','#FF0FFF','#00FFFF', ...
    '#0080FF','#F0FFFF','#F080FF','#FF8080'
};

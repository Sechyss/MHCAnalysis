...
parfor new_infection_time = 1:size(time_new_infection, 1)
    ...
    for infection= 1:size(strains, 1)
         ...
         disp(['Working on ', next_infection, ' at ', num2str(date_new_infection), ' days post infection'])
        ...
        saveas(gcf, ['/Users/u2176312/OneDrive - University of Warwick/Model/New Model/Betatesting/',new_Strain, '_infection_',num2str(date_new_infection),'_Genotype_ratios.pdf'])

function [outputTable, Timescale] = MultiGenotype_strain_model_2(population, ratios, params)
    ...
    nonZeroIndices = ratios ~= 0;
    starting_infection = [2 20 34 48];

    starting_infection = starting_infection(nonZeroIndices);
    ...
    if strcmpi(new_strain, '1a2b')
        ...
        new_infection = new_infection(nonZeroIndices);
